...
import { LayoutDashboard, Package, Plus, Newspaper, User, Ticket, Wallet, LogOut } from "lucide-react";
...
const SIDEBAR_ITEMS = [
  ...
  { label: "Mis publicaciones", href: "/panel/publicaciones",    icon: <Newspaper size={16} /> },
