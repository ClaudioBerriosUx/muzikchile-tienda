      ...
      <section className="py-12 px-6" style={{ backgroundColor: "#f8f7f5" }}>
        <div className="flex gap-8 items-start max-w-4xl mx-auto">
          ...
          <div className="flex-1 min-w-0">
            <h1
              style={{ fontFamily: "Oswald, sans-serif", fontSize: "36px", fontWeight: "700", color: "#111111", lineHeight: 1.1 }}
            >
              {artista.nombre}
            </h1>
            ...
            {artista.redes_sociales && (
              <div className="flex flex-wrap gap-2 mt-4">
                {Object.entries(artista.redes_sociales).map(([red, url]) =>
                  url ? (
                    <a
                      key={red}
                      href={url}
      ...
      <div className="max-w-6xl mx-auto">
        {tabActivo === "productos" ? (
          ...
          <div className="p-6 max-w-2xl">
            <p
              style={{ fontFamily: "DM Sans, sans-serif", fontSize: "15px", color: "#444444", lineHeight: 1.7 }}
            >
