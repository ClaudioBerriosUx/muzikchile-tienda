...
const REDES = [
  { label: "Facebook",  href: "https://facebook.com/muzikchile",           path: PATHS.facebook },
  { label: "X",         href: "https://x.com/muzikchile",                  path: PATHS.x },
  { label: "Instagram", href: "https://instagram.com/muzikchile",          path: PATHS.instagram },
  { label: "Spotify",   href: "https://open.spotify.com/user/muzikchile",  path: PATHS.spotify },
];
          ...
          <div className="flex items-center gap-3 mt-5">
            {REDES.map((r) => (
              <a
                ...
                style={{ border: `1px solid ${C.borde}`, color: C.gris }}
              >
